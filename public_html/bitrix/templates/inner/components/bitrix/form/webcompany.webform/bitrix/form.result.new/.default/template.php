        ...
        <form name="" action="" method="post">
            <table class="data-table">
                ...
                if ($arResult["isUseCaptcha"] == "Y") {
                    ?>
                    <tr>
                        <td class="label l-align c-valign"><?= GetMessage("FORM_CAPTCHA_TABLE_TITLE") ?></td>
                        <td class="data">
                            <div class="wrapper">
                    ...
                    <tr>
                        <td class="label l-align c-valign"><?= GetMessage("FORM_CAPTCHA_FIELD_TITLE") ?><?= $arResult["REQUIRED_SIGN"]; ?></td>
                        <td class="data">
                            <div class="wrapper">
